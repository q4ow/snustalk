...
async function resetDatabase() {
    ...
    try {
        ...
        await adminPool.query('GRANT ALL PRIVILEGES ON DATABASE snustalk TO keiran');
        ...
        await adminSnustalkPool.query('ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL ON TABLES TO keiran');
